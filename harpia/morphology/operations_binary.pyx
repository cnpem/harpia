...
cdef extern from "../../include/morphology/operations_binary.h":
    void _erosionBinary "erosionBinary"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _dilationBinary "dilationBinary"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _closingBinary "closingBinary"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _openingBinary "openingBinary"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
