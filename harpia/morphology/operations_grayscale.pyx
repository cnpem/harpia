...
cdef extern from "../../include/morphology/operations_grayscale.h":
    void _erosionGrayscale "erosionGrayscale"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _dilationGrayscale "dilationGrayscale"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _closingGrayscale "closingGrayscale"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
    void _openingGrayscale "openingGrayscale"[dtype](dtype *, dtype *, int *, int, int, int, int, int, int, int, int, int, int)
...
cdef extern from "../../include/morphology/top_hat.h":
    void _topHat "topHat"[dtype](dtype *, dtype *, int *, int, int, int, const int, const int, const int, const int, const int, const int, 
                                const int)
...
def topHat(numpy.ndarray[numeric, ndim=3] hostImage, numpy.ndarray[numeric, ndim=3] hostOutput, int[:,:,:] kernel, int kernel_xsize, int kernel_ysize, int kernel_zsize, 
    ...
    return  _topHat(&hostImage[0,0,0], &hostOutput[0,0,0], &kernel[0,0,0], kernel_xsize, kernel_ysize, kernel_zsize, xsize, ysize, zsize, 
...
cdef extern from "../../include/morphology/bottom_hat.h":
    void _bottomHat "bottomHat"[dtype](dtype *, dtype *, int *, int, int, int, const int, const int, const int, const int, const int, const int, 
                                const int)
...
def bottomHat(numpy.ndarray[numeric, ndim=3] hostImage, numpy.ndarray[numeric, ndim=3] hostOutput, int[:,:,:] kernel, int kernel_xsize, int kernel_ysize, int kernel_zsize, 
           const int xsize, const int ysize, const int zsize, const int block_xsize, const int block_ysize, const int block_zsize, 
           const int flag_verbose):
    return  _bottomHat(&hostImage[0,0,0], &hostOutput[0,0,0], &kernel[0,0,0], kernel_xsize, kernel_ysize, kernel_zsize, xsize, ysize, zsize, 
                    block_xsize, block_ysize, block_zsize, flag_verbose)             