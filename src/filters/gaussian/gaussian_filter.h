...
void get_gaussian_kernel_2d(float** kernel, int rows, int cols, float sigma);

// Function to generate a 3D Gaussian kernel
void get_gaussian_kernel_3d(float** kernel, int rows, int cols, int depth, float sigma);
