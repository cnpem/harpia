...
// Template instantiations for specific types
template void top_hat_aviso_on_device<int>(int*, int*, const int, const int, const int, const int,
                                           int*, int, int, int);
template void top_hat_aviso_on_device<unsigned int>(unsigned int*, unsigned int*, const int,
                                                    ...
                                                    int);
template void top_hat_aviso_on_device<float>(float*, float*, const int, const int, const int,
                                             const int, int*, int, int, int);
