...
CUDA_HOSTDEV void geodesic_morph_grayscale_pixel(dtype* image, dtype* output, dtype* mask,
...
template CUDA_HOSTDEV void geodesic_morph_grayscale_pixel<int>(int*, int*, int*, int, int, int, int,
                                                               int, int, const int, const int,
                                                               const int, MorphOp);
template CUDA_HOSTDEV void geodesic_morph_grayscale_pixel<unsigned int>(
    unsigned int*, unsigned int*, unsigned int*, int, int, int, int, int, int, const int, const int,
    const int, MorphOp);
...
template CUDA_HOSTDEV void geodesic_morph_grayscale_pixel<float>(float*, float*, float*, int, int,
...
__global__ void geodesic_morph_grayscale_kernel(dtype* deviceImage, dtype* deviceOutput,
  ...
  if (idx < xsize && idy < ysize && idz < zsize) {
    geodesic_morph_grayscale_pixel(deviceImage, deviceOutput, deviceMask, idx, idy, idz,
                                   kernel_xsize, kernel_ysize, kernel_zsize, xsize, ysize, zsize,
                                   operation);
  }
}
template __global__ void geodesic_morph_grayscale_kernel<int>(int*, int*, int*, int, int, int,
...
template __global__ void geodesic_morph_grayscale_kernel<float>(float*, float*, float*, int, int,
...
void geodesic_morph_grayscale(dtype* deviceImage, dtype* deviceOutput, dtype* deviceMask,
  ...
  geodesic_morph_grayscale_kernel<<<grid, block>>>(deviceImage, deviceOutput, deviceMask,
...
void geodesic_morph_grayscale_on_device(dtype* hostImage, dtype* hostOutput, dtype* hostMask,
  ...
  // device erosion/dialation
  geodesic_morph_grayscale(deviceImage, deviceOutput, deviceMask, xsize, ysize, zsize, operation,
                           flag_verbose);
  ...
  for (int idz = 0; idz < zsize; idz++) {
    for (int idy = 0; idy < ysize; idy++) {
      for (int idx = 0; idx < xsize; idx++) {
        ...
        geodesic_morph_grayscale_pixel(hostImage, hostOutput, hostMask, idx, idy, idz, kernel_xsize,
...
template void geodesic_morph_grayscale_on_host<unsigned int>(unsigned int*, unsigned int*,
                                                             unsigned int*, const int, const int,
                                                             const int, MorphOp);
//template void geodesic_morph_grayscale_on_host<uint16_t>(uint16_t *, uint16_t *,uint16_t *,
//const int, const int, const int, MorphOp);
