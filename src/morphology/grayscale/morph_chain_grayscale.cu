...
void morph_chain_grayscale_on_device(dtype* hostImage, dtype* hostOutput, const int xsize,
  ...
  morph_grayscale(deviceImage, deviceTmp, xsize, ysize, zsize, flag_verbose, 0, 0, deviceKernel,
                  kernel_xsize, kernel_ysize, kernel_zsize, chain.operation1);

  // Perform the second operation in the chain
  morph_grayscale(deviceTmp, deviceOutput, xsize, ysize, zsize, flag_verbose, 0, 0, deviceKernel,
                  kernel_xsize, kernel_ysize, kernel_zsize, chain.operation2);
