...
template void top_hat_reconstruction_on_device<int>(int*, int*, const int, const int, const int,
                                                    const int, int*, int, int, int);
template void top_hat_reconstruction_on_device<unsigned int>(unsigned int*, unsigned int*,
                                                             const int, const int, const int,
                                                             const int, int*, int, int, int);
template void top_hat_reconstruction_on_device<float>(float*, float*, const int, const int,
...
// Template instantiations for specific types
template void top_hat_reconstruction_on_host<int>(int*, int*, const int, const int, const int, int*,
                                                  int, int, int);
template void top_hat_reconstruction_on_host<unsigned int>(unsigned int*, unsigned int*, const int,
                                                           const int, const int, int*, int, int,
                                                           int);
template void top_hat_reconstruction_on_host<float>(float*, float*, const int, const int, const int,
                                                    int*, int, int, int);