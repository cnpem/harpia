...
__global__
void fill_holes_marker(dtype *deviceImage, dtype *deviceOutput, const int xsize, const int ysize, const int zsize)
{
...
template __global__ void fill_holes_marker<unsigned int>(unsigned int*, unsigned int*, const int, const int, const int);
template __global__ void fill_holes_marker<int>(int*, int*, const int, const int, const int);
template __global__ void fill_holes_marker<uint16_t>(uint16_t*, uint16_t*, const int, const int, const int);
                         ...
                         const int flag_verbose)
{
    ...
    reconstruction_binary(deviceMarker, deviceAux, deviceMask, xsize, ysize, zsize, DILATION, flag_verbose);
...
template void fill_holes_on_device<unsigned int>(unsigned int *, unsigned int *, const int, const int, const int, const int);
template void fill_holes_on_device<uint16_t>(uint16_t *, uint16_t *, const int, const int, const int, const int);
...
void fill_holes_on_host(dtype *hostImage, dtype *hostOutput, const int xsize, const int ysize, const int zsize)
{
    ...
    // // Reconstruction + Complement
    reconstruction_binary_on_host(hostMarker, hostOutput, hostMask, xsize, ysize, zsize, DILATION);
...
template void fill_holes_on_host<unsigned int>(unsigned int *, unsigned int *, const int, const int, const int);
