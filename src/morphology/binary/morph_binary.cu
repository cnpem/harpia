...
CUDA_HOSTDEV void morph_binary_pixel(dtype* image, dtype* output, int centerIdx, int centerIdy,
                                     int centerIdz, int* kernel, int kernel_xsize, int kernel_ysize,
                                     int kernel_zsize, const int xsize, const int ysize,
...
template CUDA_HOSTDEV void morph_binary_pixel<int>(int*, int*, int, int, int, int*, int, int, int,
                                                   const int, const int, const int, MorphOp);
template CUDA_HOSTDEV void morph_binary_pixel<unsigned int>(unsigned int*, unsigned int*, int, int,
                                                            int, int*, int, int, int, const int,
                                                            const int, const int, MorphOp);
template CUDA_HOSTDEV void morph_binary_pixel<uint16_t>(uint16_t*, uint16_t*, int, int, int, int*,
 ...
 */
template <typename dtype>
__global__ void morph_binary_kernel(dtype* deviceImage, dtype* deviceOutput, int* kernel,
  ...
  if (idx < xsize && idy < ysize && idz < zsize) {
    morph_binary_pixel(deviceImage, deviceOutput, idx, idy, idz, kernel, kernel_xsize, kernel_ysize,
                       kernel_zsize, xsize, ysize, zsize, operation);
  }
}
template __global__ void morph_binary_kernel<int>(int*, int*, int*, int, int, int, const int,
                                                  const int, const int, MorphOp);
template __global__ void morph_binary_kernel<unsigned int>(unsigned int*, unsigned int*, int*, int,
                                                           int, int, const int, const int,
                                                           const int, MorphOp);
template __global__ void morph_binary_kernel<uint16_t>(uint16_t*, uint16_t*, int*, int, int, int,
                                                       const int, const int, const int, MorphOp);

template <typename dtype>
void morph_binary(dtype* deviceImage, dtype* deviceOutput, int* deviceKernel, int kernel_xsize,
  ...
  morph_binary_kernel<<<grid, block>>>(deviceImage, deviceOutput, deviceKernel, kernel_xsize,
                                       kernel_ysize, kernel_zsize, xsize, ysize, zsize, operation);
  cudaDeviceSynchronize();  //assures all gpu threads are fineshed
}
template void morph_binary<int>(int*, int*, int*, int, int, int, const int, const int, const int,
                                MorphOp, const int);
template void morph_binary<unsigned int>(unsigned int*, unsigned int*, int*, int, int, int,
                                         const int, const int, const int, MorphOp, const int);
template void morph_binary<uint16_t>(uint16_t*, uint16_t*, int*, int, int, int, const int,
 ...
 */
template <typename dtype>
void morph_binary_on_device(dtype* hostImage, dtype* hostOutput, int* kernel, int kernel_xsize,
                            int kernel_ysize, int kernel_zsize, const int xsize, const int ysize,
                            const int zsize, MorphOp operation, const int flag_verbose) {
  // set input dimension
  ...
  // device erosion/dialation
  morph_binary(deviceImage, deviceOutput, deviceKernel, kernel_xsize, kernel_ysize, kernel_zsize,
...
template void morph_binary_on_device<int>(int*, int*, int*, int, int, int, const int, const int,
                                          const int, MorphOp, const int);
template void morph_binary_on_device<unsigned int>(unsigned int*, unsigned int*, int*, int, int,
                                                   int, const int, const int, const int, MorphOp,
                                                   const int);
template void morph_binary_on_device<uint16_t>(uint16_t*, uint16_t*, int*, int, int, int, const int,
                                               const int, const int, MorphOp, const int);
 ...
 */
template <typename dtype>
void morph_binary_on_host(dtype* hostImage, dtype* hostOutput, int* kernel, int kernel_xsize,
                          int kernel_ysize, int kernel_zsize, const int xsize, const int ysize,
                          const int zsize, MorphOp operation) {
  ...
  for (int idz = 0; idz < zsize; idz++) {
    for (int idy = 0; idy < ysize; idy++) {
      for (int idx = 0; idx < xsize; idx++) {
        ...
        morph_binary_pixel(hostImage, hostOutput, idx, idy, idz, kernel, kernel_xsize, kernel_ysize,
                           kernel_zsize, xsize, ysize, zsize, operation);
      }
    }
  }  // slide over image
}
template void morph_binary_on_host<int>(int*, int*, int*, int, int, int, const int, const int,
                                        const int, MorphOp);
template void morph_binary_on_host<unsigned int>(unsigned int*, unsigned int*, int*, int, int, int,
                                                 const int, const int, const int, MorphOp);
template void morph_binary_on_host<uint16_t>(uint16_t*, uint16_t*, int*, int, int, int, const int,
                                             const int, const int, MorphOp);
