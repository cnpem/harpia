#ifndef TEST_MORPHOLOGY_GRAYSCALE_PINNED_H
#define TEST_MORPHOLOGY_GRAYSCALE_PINNED_H

#include <string>
#include "../../morphology/morphology.h"

void test_morph_grayscale_pinned_on_device(const std::string& filename, const int xsize,
