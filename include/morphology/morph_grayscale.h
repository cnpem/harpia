...
/**
 * @brief Apply a grayscale morphological operation (erosion or dilation) to an entire image using the GPU.
 * 
...
/**
 * @brief Perform grayscale erosion or dilation on an entire image using the GPU.
 *
...
void morph_grayscale_on_device(dtype* hostImage, dtype* hostOutput, const int xsize,
                               ...
                               MorphOp operation);
/**
 * @brief Perform grayscale morphological operations (erosion or dilation) on the host (CPU).
 *
 * This function applies a grayscale morphological operation (either erosion or dilation)
