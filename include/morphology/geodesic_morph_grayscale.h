...
/**
 * @brief Launches the CUDA kernel for grayscale geodesic morphological operations.
 *
 ...
 *       on pages 667-668.
 * @see geodesic_morph_grayscale_kernel()
 */
...
/**
 * @brief Perform geodesic grayscale erosion/dilation operation on the entire image using the GPU.
...
void geodesic_morph_grayscale_on_device(dtype* hostImage, dtype* hostMask, dtype* hostOutput,
                                        ...
                                        const int padding_top, MorphOp operation);
/**
 * @brief Perform geodesic grayscale erosion/dilation operation on the entire image using the CPU.
