...
/**
 * @brief Performs closing/opening operation on a binary image using the GPU.
 *
 * This function applies a sequence of erosion and dilation operations, commonly used for 
 * morphological opening or closing, to a binary image on the GPU. It supports 3D images and 
...
/**
 * @brief Performs a closing/opening operation on a binary image using the CPU.
 *
 * This function applies a sequence of erosion and dilation operations, commonly used for 
 * morphological opening or closing, to a binary image on the CPU. It supports 3D images and 
 * configurable kernel sizes.
 *
