...
void test_morph_binary_pinned_on_device(const std::string& filename, const int xsize,
  ...
  morph_binary_pinned_on_device(host_A, device_ref, xsize, ysize, zsize, kernel, kernel_xsize,
  ...
  if (flag_check) {
    ...
    morph_binary_pinned_on_host(host_A, host_ref, xsize, ysize, zsize, kernel, kernel_xsize,
