...
operations_grayscale = [
    ("Erosion 3D grayscale", None, erosion_grayscale, None),
    ("Dilation 3D grayscale", None, dilation_grayscale, None),
    ("Closing 3D grayscale", None, closing_grayscale, None),
    ("Opening 3D grayscale", None, opening_grayscale, None),
...
#    ("Geodesisc Dilation 3D grayscale", None, geodesic_dilation_grayscale, "geodesic_dilation_grayscale"),
    ("Top Hat 3D grayscale", None, top_hat, None),
    ("Bottom Hat 3D grayscale", None, bottom_hat, None),
]
operations_filters = [
    # ("Gaussian Filter 3D grayscale", None, gaussianFilter, None), #OK
    ("Mean Filter 3D grayscale", None, meanFilter, None), #OK
    # ("Log Filter 3D grayscale", None, logFilter, None), #illegal memory access
    ("Unsharp Mask Filter 3D grayscale", None, unsharpMaskFilter, None),
    ("Sobel Filter 3D grayscale", None, sobelFilter, None),
    ("Prewitt Filter 3D grayscale", None, prewittFilter, None),
    ("Anisotropic Diffusion Filter 3D grayscale", None, anisotropic_diffusion3D, None), #only runs in float images
]
