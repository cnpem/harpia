...
parser.add_argument(
    "--cuda", type=str, default="12.6", help="CUDA version (default=%(default)s)."
)
...
parser.add_argument(
    "--cudnn", type=str, default="9.10.2", help="cuDNN version (default=%(default)s)."
)
...
major_cudnn = args.cudnn.split('.')[0]  # Get major version only
devel_image = f"nvcr.io/nvidia/cuda:{args.cuda}-cudnn{major_cudnn}-devel-{args.distro}.04"
runtime_image = f"nvcr.io/nvidia/cuda:{args.cuda}-cudnn{major_cudnn}-runtime-{args.distro}.04"
